...
abstract class $CountryModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: 'phone_length') int phoneLength,
  });
}
...
class _$CountryModelImpl implements _CountryModel {
  const _$CountryModelImpl({
    ...
    @JsonKey(name: 'phone_length') required this.phoneLength,
  });
  ...
  @override
  String toString() {
    return 'CountryModel(id: $id, name: $name, flag: $flag, phoneCode: $phoneCode, phoneLength: $phoneLength)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, flag, phoneCode, phoneLength);
...
abstract class _CountryModel implements CountryModel {
  const factory _CountryModel({
    ...
    @JsonKey(name: 'phone_length') required final int phoneLength,
  }) = _$CountryModelImpl;
