...
class _LoginPageState extends State<LoginPage> {
  ...
  VerificationMethod _verificationMethod = VerificationMethod.whatsapp;
          ...
          BlocConsumer<AuthBloc, AuthState>(
            listener: (context, state) {
              if (state is AuthError) {
                ...
                context.push(AppRouter.verification, extra: state.phone);
                                    ...
                                    children: [
                                      Expanded(
                                        child: CustomSelectionCard(
                                          title: l10n.sms,
                                          isSelected: _verificationMethod == VerificationMethod.sms,
                                          onTap: () => setState(() => _verificationMethod = VerificationMethod.sms),
                                      ...
                                      Expanded(
                                        child: CustomSelectionCard(
                                          title: l10n.whatsapp,
                                          isSelected: _verificationMethod == VerificationMethod.whatsapp,
                                          onTap: () => setState(() => _verificationMethod = VerificationMethod.whatsapp),
                            ...
                            onPressed: () {
                              if (_phoneController.text.isNotEmpty) {
                                context.read<AuthBloc>().add(
                                      LoginRequested(_phoneController.text, _verificationMethod),
                                    );
                              }
                            },
                          ),
